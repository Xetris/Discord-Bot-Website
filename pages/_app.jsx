...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.gg/ZbdBCu6KRa",
    },
    {
      link: true,
      name: "Add Bot",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=1125113502953115709&permissions=277028603968&scope=applications.commands%20bot",
    },
       {
      link: true,
      name: "Vote",
